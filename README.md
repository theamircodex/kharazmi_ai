# نکته قابل توجه : 
نکته ای مهم که امروز متوجه آن شدم و لازم بود که به اطلاع برسانم (امروز 12 مرداد) این است که سایت freesewing https://freesewing.org جدیدا برای آی پی ایران تحریم شده و برای استفاده از آن فیلتر شکن روشن کنید (فقط این پاراگراف بتازگی اضافه شده است)
...
https://drive.google.com/file/d/1KE92Yopweuh5a6MVcqft1QDx7SooxWes/view?usp=sharing
